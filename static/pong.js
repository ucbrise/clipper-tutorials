    ...
    switch (keyCode) {
      ...
      case Game.KEY.Q:
        if (!this.leftPaddle.auto){
          ...
          // console.log("up", this.leftPaddle.y, this.ball.x, this.ball.y,
          //             this.ball.dx, this.ball.dy,this.ball.x_prev, this.ball.y_prev)
          var data1 = JSON.stringify({"label": "up",
                                      "leftPaddle_y": this.leftPaddle.y,
                                      "ball_x": this.ball.x,
                                      "ball_y": this.ball.y,
      ...
      case Game.KEY.A:
        if (!this.leftPaddle.auto) {
          ...
          console.log("down", this.leftPaddle.y, this.ball.x, this.ball.y,
                      this.ball.dx, this.ball.dy,this.ball.x_prev, this.ball.y_prev)
          var data1 = JSON.stringify({"label": "down",
                                      "leftPaddle_y": this.leftPaddle.y,
                                      "ball_x": this.ball.x,
                                      "ball_y": this.ball.y,
                                      "ball_dx": this.ball.dx,
    ...
    switch (keyCode) {
      case Game.KEY.Q:
        if (!this.leftPaddle.auto){
          ...
          console.log("stop", this.leftPaddle.y, this.ball.x, this.ball.y,
                      this.ball.dx, this.ball.dy,this.ball.x_prev, this.ball.y_prev)
          var data1 = JSON.stringify({"label": "stop",
                                      "leftPaddle_y": this.leftPaddle.y,
                                      "ball_x": this.ball.x,
                                      "ball_y": this.ball.y,
                                      "ball_dx": this.ball.dx,
      ...
      case Game.KEY.UP:
        if (!this.rightPaddle.auto){
          this.rightPaddle.stopMovingUp();
          // console.log("stop", this.ball.x, this.ball.y, this.ball.accel, this.ball.speed, this.rightPaddle.x, this.rightPaddle.y);
        }
        break;
      case Game.KEY.L:
        if (!this.rightPaddle.auto){
